...
var loopSlide = null;
var sl_speed = 3000; // Slide transition speed (3 seconds)

carouselElement.addClass("pbmit-element-viewtype-carousel-" + x);

if (columns === 1) {
var responsive_items = [columns, "1", "1", "1", "1"];
} else if (columns === 2 || columns == 2.6) {
var responsive_items = [columns, "2", "2", "2", "1"];
} else if (columns === 3) {
var responsive_items = [columns, "2", "2", "1", "1"];
} else if (columns === 3 || columns == 3.6) {
var responsive_items = [columns, "2.3", "2", "2", "1"];
} else if (columns === 4) {
var responsive_items = [columns, "4", "3", "2", "1"];
} else if (columns === 5) {
var responsive_items = ["5", "4", "3", "2", "1"];
} else if (columns === 6) {
var responsive_items = ["6", "4", "3", "2", "1"];
} else {
var responsive_items = ["3", "3", "2", "2", "1"];
}
...
autoplay: {
delay: 7000, // Delay between slides in ms (5 seconds)
...
-------------------------------------*/
$(
".active-onhover .pbmit-miconheading-style-3:nth-child(2),.pbmit-miconheading-style-37:first-child"
).addClass("pbmit-mihbox-hover-active");

$(".active-onhover .pbmit-miconheading-style-3,.pbmit-miconheading-style-37")
.mouseover(function () {
var main_row = $(this).closest(".active-onhover");
$(
".pbmit-miconheading-style-3,.pbmit-miconheading-style-37",
main_row
...
$(
".pbmit-miconheading-style-3:nth-child(2),.pbmit-miconheading-style-37:first-child",
main_row
).addClass("pbmit-mihbox-hover-active");
});
...
jQuery('.pbmit-sortable-list a[data-sortby="rd"]').trigger('click');
});*/
...
itemSelector: ".pbmit-portfolio-style-1",
layoutMode: "fitRows"
});

// Determine the default active filter based on the "pbmit-selected" class
var defaultFilterSelector = jQuery('.pbmit-sortable-list a.pbmit-selected').data("sortby");
if (defaultFilterSelector !== "*") {
defaultFilterSelector = "." + defaultFilterSelector;
}
// Apply the default filter to Isotope
boxes.isotope({ filter: defaultFilterSelector });
